...
![2.png](../img/S2-059/images/2.png)

![3.png](../img/S2-059/images/3.png)

&emsp;&emsp;&emsp;&emsp;3.F7继续进入父方法populateParams,然后F7继续进入父方法populateParams

![4.png](../img/S2-059/images/4.png)

![5.png](../img/S2-059/images/5.png)

&emsp;&emsp;&emsp;&emsp;4.就可以看到了具体设置参数的函数,找到设置id的地方,F7进入setId方法

![6.png](../img/S2-059/images/6.png)

![7.png](../img/S2-059/images/7.png)

&emsp;&emsp;&emsp;&emsp;5.见到了熟悉方法,findString,F7进入findString方法

![8.png](../img/S2-059/images/8.png)

&emsp;&emsp;&emsp;&emsp;6.F7继续进入findValue方法

![9.png](../img/S2-059/images/9.png)
...
![10.png](../img/S2-059/images/10.png)

![11.png](../img/S2-059/images/11.png)

![12.png](../img/S2-059/images/12.png)
...
![13.png](../img/S2-059/images/13.png)

![14.png](../img/S2-059/images/14.png)

![15.png](../img/S2-059/images/15.png)

&emsp;&emsp;&emsp;&emsp;9.回到doStartTag方法,继续往下执行.F7进入start方法.

![16.png](../img/S2-059/images/16.png)

&emsp;&emsp;&emsp;&emsp;10.F7进入父方法start,然后F7进入evalvateParams方法

![17.png](../img/S2-059/images/17.png)

![18.png](../img/S2-059/images/18.png)

&emsp;&emsp;&emsp;&emsp;11.evalvateParams方法添加了一些参数,然后解析参数.F7进入populateComponentHtmlId方法.

![19.png](../img/S2-059/images/19.png)

![20.png](../img/S2-059/images/20.png)

&emsp;&emsp;&emsp;&emsp;12.F7进入findStringIfAltSyntax方法.发现还是判断是否开启了altSyntax,开启后才会继续下去,默认altSyntax是开启的.F7进入findString方法.

![21.png](../img/S2-059/images/21.png)

![22.png](../img/S2-059/images/22.png)
...
![23.png](../img/S2-059/images/23.png)

![24.png](../img/S2-059/images/24.png)

![25.png](../img/S2-059/images/25.png)

![26.png](../img/S2-059/images/26.png)

&emsp;&emsp;&emsp;&emsp;14.F7进入evalvate方法,在第56行Object o = evaluator.evaluate(var);进行了第二次解析,解析后%{11*11}变成了121,解析后通过值栈查找并将其返回.

![27.png](../img/S2-059/images/27.png)

![28.png](../img/S2-059/images/28.png)
