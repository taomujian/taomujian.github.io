...
![action](img/S2-001/images/action.png)
...
![struts.xml](img/S2-001/images/struts_xml.png)
...
![LoginAction](img/S2-001/images/LoginAction.png)

![error](img/S2-001/images/error.png)
...
![expression](img/S2-001/images/expression.png)
...
![o](img/S2-001/images/o.png)

F7进入findValue方法

![findValue2](img/S2-001/images/findValue2.png)

F7进入getValue方法,进入后根据name的值进行compile,name的值为password,会从root栈中LoginAction对象中获取到提交的参数%{1+1}并返回

![complie](img/S2-001/images/compile.png)

o经过一些处理后赋值给expression,expression变为%{1+1}

![expression_2](img/S2-001/images/express_2.png)

继续循环,进过findValue处理后可看到ongl表达式已被执行,结果为2

![succes](img/S2-001/images/sucess.png)
