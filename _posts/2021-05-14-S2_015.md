...
![5.png](img/S2-015/images/5.png)

![6.png](img/S2-015/images/6.png)

&emsp;&emsp;&emsp;&emsp;6.对比下execute方法第86行和87行前后的结果,可见经过translateVariables方法后value的值从${message}变成了执行了id命令后的结果.

![7.png](img/S2-015/images/7.png)

![8.png](img/S2-015/images/8.png)
